...
There as a cool paper about horses once [@milner1969weight].
...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Horse population for all provinces in Canada 1940-1972", out.width = "100%"}
...
kable(max_horses, caption="Table 1. Maximum and minimum number of horses for each province between 194-1972")

```

Below we zoom in and look at the province of Alberta:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Number of horse for province of focus", out.width = "50%"}
